...
class BasisExport
{
    ...
    */
    function getMetrics($export_date = '', $export_format = 'json')
    {
        ...
        if ($export_format == 'html') {
            ...
            $file = 'data/basis-data-' . $export_date . '-metrics.html';
            ...
            $file = './data/basis-data-' . $export_date . '-metrics.csv';
            ...
            $file = './data/basis-data-' . $export_date . '-metrics.json';
    ...
    */
    function getSleep($export_date = '', $export_format = 'json')
    {
        ...
        if ($export_format == 'html') {
            // Save results as .html file
            $file = './data/basis-data-' . $export_date . '-sleep.html';
            ...
            // Save results as .csv file
            $file = './data/basis-data-' . $export_date . '-sleep.csv';
            ...
            // Save results as .json file
            $file = './data/basis-data-' . $export_date . '-sleep.json';
            if (!file_put_contents($file, $result)) {
                throw new Exception("ERROR: Could not save data to file $file!");
                return false;
            }
    ...
    */
    function getActivities($export_date = '', $export_format = 'json')
    {
        ...
        if ($export_format == 'html') {
            // Save results as .html file
            $file = './data/basis-data-' . $export_date . '-activities.html';
            ...
            // Save results as .csv file
            $file = './data/basis-data-' . $export_date . '-activities.csv';
            ...
            // Save results as .json file
            $file = './data/basis-data-' . $export_date . '-activities.json';
            if (!file_put_contents($file, $result)) {
                throw new Exception("ERROR: Could not save data to file $file!");
                return false;
            }
